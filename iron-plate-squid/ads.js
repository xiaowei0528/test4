...
preloader.adTagUrl = 'https://googleads.g.doubleclick.net/pagead/ads?ad_type=video_image&client=ca-pub-9809822100114285&description_url=http%3A%2F%2Fwww.i8box.com&videoad_start_delay=-1&hl=zh_CN&max_ad_duration=15000';
	...
	// alert("showMy");
		if (typeof(killads)=='undefined'){
            ...
            if (document.body.clientHeight > 700){
                document.getElementById("adContainer").style.height = winHeight-80-5+"px";
            }else{
                document.getElementById("adContainer").style.height = winHeight-60-5+"px";
            }
